...
class Publisher(object):
    ...
    def setup_queue(self, queue_name, routing_key_name):
        ...
        :param str|unicode routing_key_name: The routing key of queue
        """
    ...
    def queue_add_routing_key(self, queue_name, routing_key_name):
        ...
        """
        LOGGER.info('Binding %s to %s with %s',
                    self.exchange, queue_name, routing_key_name)
        self._channel.queue_bind(self.on_bindok, queue_name,
                                 self.exchange, routing_key_name)
...
def configure():
    example.setup_queue('vm_delete','vm_delete')
